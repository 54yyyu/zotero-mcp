...
- **Gemini**: Better quality, requires API key (`gemini-embedding-001` or `gemini-embedding-002`)
...
- `GEMINI_EMBEDDING_MODEL`: Gemini model name (default: gemini-embedding-002, also supports gemini-embedding-001)
