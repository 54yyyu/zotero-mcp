...
def _reports_failure(text: str) -> bool:
    ...
    "Cannot ...", "Group ...", "Feed ...", "Personal ..."). Only the opening
    words count: a success message may quote an error further down, and must
    stay a success.
    """
    global _FAILURE_RE
    if _FAILURE_RE is None:
        ...
        _FAILURE_RE = re.compile(
            r"^[\s#*>]*(Error\b|Failed to\b|Could not\b|Cannot\b|Group\b|Feed\b|Personal\b)"
        )
