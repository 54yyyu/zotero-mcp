    ...
    *,
    ...
    try:
        ...
        for i, item in enumerate(results, 1):
            ...
            if concise:
                # Concise format: Number. Title (Year) - Author [Key]
                date = data.get("date", "")
                ...
                # Add very short abstract if present
    ...
    *,
    ...
    try:
        ...
        for i, anno in enumerate(annotations, 1):
            ...
            if concise:
                # Concise format: just the text and comment with page number
                page_info = ""
                if "_pdf_page" in data:
                    page_info = f" (p. {data['_pdf_page']})"
                
                # Truncate text for concise mode
                if anno_text:
